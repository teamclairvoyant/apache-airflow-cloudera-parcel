...
<dd><p>Bases: <a class="reference internal" href="#airflow.models.BaseOperator" title="airflow.models.BaseOperator"><code class="xref py py-class docutils literal"><span class="pre">airflow.models.BaseOperator</span></code></a></p>
<p>Execute a Bash script, command or set of commands at remote host.</p>
<table class="docutils field-list" frame="void" rules="none">
<col class="field-name" />
<col class="field-body" />
<tbody valign="top">
<tr class="field-odd field"><th class="field-name">Parameters:</th><td class="field-body"><ul class="first last simple">
<li><strong>ssh_hook</strong> &#8211; A SSHHook that indicates the remote host
you want to run the script</li>
<li><strong>ssh_hook</strong> &#8211; SSHHook</li>
<li><strong>bash_command</strong> (<em>string</em>) &#8211; The command, set of commands or reference to a
bash script (must be &#8216;.sh&#8217;) to be executed.</li>
<li><strong>env</strong> (<em>dict</em>) &#8211; If env is not None, it must be a mapping that defines the
environment variables for the new process; these are used instead
...
<tr class="row-even"><td><code class="docutils literal"><span class="pre">conf</span></code></td>
...
<tr class="row-odd"><td><code class="docutils literal"><span class="pre">run_id</span></code></td>
<td>the <code class="docutils literal"><span class="pre">run_id</span></code> of the current DAG run</td>
</tr>
<tr class="row-even"><td><code class="docutils literal"><span class="pre">dag_run</span></code></td>
<td>a reference to the DagRun object</td>
</tr>
<tr class="row-odd"><td><code class="docutils literal"><span class="pre">test_mode</span></code></td>
...
<li><strong>before</strong> (<em>bool or None</em>) &#8211; closest before (True), after (False) or either side of ds</li>
</ul>
</td>
</tr>
...
<li><strong>schedule_interval</strong> (<em>datetime.timedelta or
...
<li><strong>template_searchpath</strong> (<em>string or list of stings</em>) &#8211; This list of folders (non relative)
...
<code class="descname">crawl_for_tasks</code><span class="sig-paren">(</span><em>objects</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/airflow/models.html#DAG.crawl_for_tasks"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.models.DAG.crawl_for_tasks" title="Permalink to this definition">¶</a></dt>
...
<dd><p>Creates a dag run from this dag including the tasks associated with this dag. Returns the dag
run.
...
<dd><p>Returns the latest date for which at least one task instance exists</p>
</dd></dl>
...
<code class="descname">run</code><span class="sig-paren">(</span><em>start_date=None</em>, <em>end_date=None</em>, <em>ignore_dependencies=False</em>, <em>ignore_first_depends_on_past=False</em>, <em>force=False</em>, <em>mark_success=False</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/airflow/models.html#BaseOperator.run"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.models.BaseOperator.run" title="Permalink to this definition">¶</a></dt>
...
<tbody valign="top">
<tr class="field-odd field"><th class="field-name">Parameters:</th><td class="field-body"><ul class="first last simple">
<li><strong>flag_upstream_failed</strong> (<em>boolean</em>) &#8211; This is a hack to generate
the upstream_failed state creation while checking to see
whether the task instance is runnable. It was the shortest
path to add the feature</li>
<li><strong>ignore_depends_on_past</strong> (<em>boolean</em>) &#8211; if True, ignores depends_on_past
dependencies. Defaults to False.</li>
<li><strong>verbose</strong> (<em>boolean</em>) &#8211; verbose provides more logging in the case where the
...
logging would be way too verbose.</li>
</ul>
</td>
</tr>
</tbody>
...
<code class="descname">command</code><span class="sig-paren">(</span><em>mark_success=False</em>, <em>ignore_dependencies=False</em>, <em>ignore_depends_on_past=False</em>, <em>force=False</em>, <em>local=False</em>, <em>pickle_id=None</em>, <em>raw=False</em>, <em>job_id=None</em>, <em>pool=None</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/airflow/models.html#TaskInstance.command"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.models.TaskInstance.command" title="Permalink to this definition">¶</a></dt>
...
<dl class="method">
<dt id="airflow.models.TaskInstance.evaluate_trigger_rule">
<code class="descname">evaluate_trigger_rule</code><span class="sig-paren">(</span><em>*args</em>, <em>**kwargs</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/airflow/models.html#TaskInstance.evaluate_trigger_rule"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.models.TaskInstance.evaluate_trigger_rule" title="Permalink to this definition">¶</a></dt>
<dd><p>Returns a boolean on whether the current task can be scheduled
for execution based on its trigger_rule.</p>
<table class="docutils field-list" frame="void" rules="none">
<col class="field-name" />
<col class="field-body" />
<tbody valign="top">
...
whether the task instance is runnable. It was the shortest
path to add the feature</li>
<li><strong>successes</strong> (<em>boolean</em>) &#8211; Number of successful upstream tasks</li>
<li><strong>skipped</strong> (<em>boolean</em>) &#8211; Number of skipped upstream tasks</li>
<li><strong>failed</strong> (<em>boolean</em>) &#8211; Number of failed upstream tasks</li>
<li><strong>upstream_failed</strong> (<em>boolean</em>) &#8211; Number of upstream_failed upstream tasks</li>
<li><strong>done</strong> (<em>boolean</em>) &#8211; Number of completed upstream tasks</li>
</ul>
</td>
</tr>
</tbody>
...
<code class="descname">is_queueable</code><span class="sig-paren">(</span><em>include_queued=False</em>, <em>ignore_depends_on_past=False</em>, <em>flag_upstream_failed=False</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/airflow/models.html#TaskInstance.is_queueable"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.models.TaskInstance.is_queueable" title="Permalink to this definition">¶</a></dt>
...
<tbody valign="top">
<tr class="field-odd field"><th class="field-name">Parameters:</th><td class="field-body"><ul class="first last simple">
<li><strong>include_queued</strong> (<em>boolean</em>) &#8211; If True, tasks that have already been queued
are included. Defaults to False.</li>
<li><strong>ignore_depends_on_past</strong> (<em>boolean</em>) &#8211; if True, ignores depends_on_past
dependencies. Defaults to False.</li>
<li><strong>flag_upstream_failed</strong> (<em>boolean</em>) &#8211; This is a hack to generate
the upstream_failed state creation while checking to see
...
<code class="descname">is_runnable</code><span class="sig-paren">(</span><em>include_queued=False</em>, <em>ignore_depends_on_past=False</em>, <em>flag_upstream_failed=False</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/airflow/models.html#TaskInstance.is_runnable"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.models.TaskInstance.is_runnable" title="Permalink to this definition">¶</a></dt>
...
<tbody valign="top">
<tr class="field-odd field"><th class="field-name">Parameters:</th><td class="field-body"><ul class="first last simple">
<li><strong>include_queued</strong> (<em>boolean</em>) &#8211; If True, tasks that are already QUEUED are
considered &#8220;runnable&#8221;. Defaults to False.</li>
<li><strong>ignore_depends_on_past</strong> (<em>boolean</em>) &#8211; if True, ignores depends_on_past
dependencies. Defaults to False.</li>
</ul>
</td>
...
<li><strong>task_ids</strong> (<em>string or iterable of strings (representing task_ids)</em>) &#8211; Only XComs from tasks with matching ids will be
...
<tbody valign="top">
<tr class="field-odd field"><th class="field-name">Parameters:</th><td class="field-body"><ul class="first last simple">
<li><strong>sql</strong> (<em>str or list</em>) &#8211; the sql statement to be executed (str) or a list of
sql statements to execute</li>
<li><strong>parameters</strong> (<em>mapping or iterable</em>) &#8211; The parameters to render the SQL query with.</li>
</ul>
</td>
</tr>
</tbody>
...
<em class="property">class </em><code class="descclassname">airflow.hooks.</code><code class="descname">DruidHook</code><span class="sig-paren">(</span><em>druid_query_conn_id='druid_query_default'</em>, <em>druid_ingest_conn_id='druid_ingest_default'</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/druid_hook.html#DruidHook"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.hooks.DruidHook" title="Permalink to this definition">¶</a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal"><span class="pre">airflow.hooks.base_hook.BaseHook</span></code></p>
<p>Interact with druid.</p>
<dl class="method">
<dt id="airflow.hooks.DruidHook.construct_ingest_query">
<code class="descname">construct_ingest_query</code><span class="sig-paren">(</span><em>datasource</em>, <em>static_path</em>, <em>ts_dim</em>, <em>columns</em>, <em>metric_spec</em>, <em>intervals</em>, <em>num_shards</em>, <em>target_partition_size</em>, <em>hadoop_dependency_coordinates=None</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/druid_hook.html#DruidHook.construct_ingest_query"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.hooks.DruidHook.construct_ingest_query" title="Permalink to this definition">¶</a></dt>
...
<tbody valign="top">
<tr class="field-odd field"><th class="field-name">Parameters:</th><td class="field-body"><ul class="first last simple">
<li><strong>datasource</strong> &#8211; target datasource in druid</li>
<li><strong>columns</strong> &#8211; list of all columns in the TSV, in the right order</li>
</ul>
</td>
</tr>
</tbody>
...
<dl class="method">
<dt id="airflow.hooks.DruidHook.get_conn">
<code class="descname">get_conn</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="reference internal" href="_modules/druid_hook.html#DruidHook.get_conn"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.hooks.DruidHook.get_conn" title="Permalink to this definition">¶</a></dt>
<dd><p>Returns a druid connection object for query</p>
</dd></dl>
...
<dl class="class">
<dt id="airflow.hooks.MsSqlHook">
<em class="property">class </em><code class="descclassname">airflow.hooks.</code><code class="descname">MsSqlHook</code><span class="sig-paren">(</span><em>*args</em>, <em>**kwargs</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/mssql_hook.html#MsSqlHook"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.hooks.MsSqlHook" title="Permalink to this definition">¶</a></dt>
...
<dl class="method">
<dt id="airflow.hooks.MsSqlHook.get_conn">
<code class="descname">get_conn</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="reference internal" href="_modules/mssql_hook.html#MsSqlHook.get_conn"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.hooks.MsSqlHook.get_conn" title="Permalink to this definition">¶</a></dt>
...
<code class="descname">load_file</code><span class="sig-paren">(</span><em>filename</em>, <em>key</em>, <em>bucket_name=None</em>, <em>replace=False</em>, <em>multipart_bytes=5368709120</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/S3_hook.html#S3Hook.load_file"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.hooks.S3Hook.load_file" title="Permalink to this definition">¶</a></dt>
...
<li><strong>multipart_bytes</strong> (<em>int</em>) &#8211; If provided, the file is uploaded in parts of
...
<code class="descname">load_string</code><span class="sig-paren">(</span><em>string_data</em>, <em>key</em>, <em>bucket_name=None</em>, <em>replace=False</em>, <em>encrypt=False</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/S3_hook.html#S3Hook.load_string"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.hooks.S3Hook.load_string" title="Permalink to this definition">¶</a></dt>
<dd><p>Loads a local file to S3</p>
...
<dl class="class">
<dt id="airflow.hooks.WebHDFSHook">
<em class="property">class </em><code class="descclassname">airflow.hooks.</code><code class="descname">WebHDFSHook</code><span class="sig-paren">(</span><em>webhdfs_conn_id='webhdfs_default'</em>, <em>proxy_user=None</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/webhdfs_hook.html#WebHDFSHook"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.hooks.WebHDFSHook" title="Permalink to this definition">¶</a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal"><span class="pre">airflow.hooks.base_hook.BaseHook</span></code></p>
<p>Interact with HDFS. This class is a wrapper around the hdfscli library.</p>
<dl class="method">
<dt id="airflow.hooks.WebHDFSHook.check_for_path">
<code class="descname">check_for_path</code><span class="sig-paren">(</span><em>hdfs_path</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/webhdfs_hook.html#WebHDFSHook.check_for_path"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.hooks.WebHDFSHook.check_for_path" title="Permalink to this definition">¶</a></dt>
<dd><p>Check for the existence of a path in HDFS by querying FileStatus.</p>
</dd></dl>

<dl class="method">
<dt id="airflow.hooks.WebHDFSHook.get_conn">
<code class="descname">get_conn</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="reference internal" href="_modules/webhdfs_hook.html#WebHDFSHook.get_conn"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.hooks.WebHDFSHook.get_conn" title="Permalink to this definition">¶</a></dt>
<dd><p>Returns a hdfscli InsecureClient object.</p>
</dd></dl>

<dl class="method">
<dt id="airflow.hooks.WebHDFSHook.load_file">
<code class="descname">load_file</code><span class="sig-paren">(</span><em>source</em>, <em>destination</em>, <em>overwrite=True</em>, <em>parallelism=1</em>, <em>**kwargs</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/webhdfs_hook.html#WebHDFSHook.load_file"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.hooks.WebHDFSHook.load_file" title="Permalink to this definition">¶</a></dt>
...
<li><strong>**kwargs</strong> &#8211; Keyword arguments forwarded to <code class="xref py py-meth docutils literal"><span class="pre">upload()</span></code>.</li>
</ul>
</td>
</tr>
</tbody>
...
<dl class="method">
<dt id="airflow.contrib.hooks.VerticaHook.get_conn">
<code class="descname">get_conn</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="reference internal" href="_modules/vertica_hook.html#VerticaHook.get_conn"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.contrib.hooks.VerticaHook.get_conn" title="Permalink to this definition">¶</a></dt>
...
<tr class="field-odd field"><th class="field-name">Parameters:</th><td class="field-body"><ul class="first last simple">
<li><strong>remote_full_path</strong> (<em>str</em>) &#8211; full path to the remote file</li>
<li><strong>local_full_path_or_buffer</strong> (<em>str or file-like buffer</em>) &#8211; full path to the local file or a
file-like buffer</li>
</ul>
</td>
</tr>
...
<dl class="class">
<dt id="airflow.contrib.hooks.SSHHook">
<em class="property">class </em><code class="descclassname">airflow.contrib.hooks.</code><code class="descname">SSHHook</code><span class="sig-paren">(</span><em>conn_id='ssh_default'</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/ssh_hook.html#SSHHook"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.contrib.hooks.SSHHook" title="Permalink to this definition">¶</a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal"><span class="pre">airflow.hooks.base_hook.BaseHook</span></code></p>
<p>Light-weight remote execution library and utilities.</p>
<p>Using this hook (which is just a convenience wrapper for subprocess),
is created to let you stream data from a remotely stored file.</p>
<p>As a bonus, <a class="reference internal" href="#airflow.contrib.hooks.SSHHook" title="airflow.contrib.hooks.SSHHook"><code class="xref py py-class docutils literal"><span class="pre">SSHHook</span></code></a> also provides a really cool feature that let&#8217;s you
set up ssh tunnels super easily using a python context manager (there is an example
in the integration part of unittests).</p>
<table class="docutils field-list" frame="void" rules="none">
<col class="field-name" />
<col class="field-body" />
<tbody valign="top">
<tr class="field-odd field"><th class="field-name">Parameters:</th><td class="field-body"><ul class="first last simple">
<li><strong>key_file</strong> (<em>str</em>) &#8211; Typically the SSHHook uses the keys that are used by the user
airflow is running under. This sets the behavior to use another file instead.</li>
<li><strong>connect_timeout</strong> (<em>int</em>) &#8211; sets the connection timeout for this connection.</li>
<li><strong>no_host_key_check</strong> (<em>bool</em>) &#8211; whether to check to host key. If True host keys will not
be checked, but are also not stored in the current users&#8217;s known_hosts file.</li>
<li><strong>tty</strong> (<em>bool</em>) &#8211; allocate a tty.</li>
<li><strong>sshpass</strong> (<em>bool</em>) &#8211; Use to non-interactively perform password authentication by using
sshpass.</li>
</ul>
</td>
</tr>
...
<dl class="method">
<dt id="airflow.contrib.hooks.SSHHook.Popen">
<code class="descname">Popen</code><span class="sig-paren">(</span><em>cmd</em>, <em>**kwargs</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/ssh_hook.html#SSHHook.Popen"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.contrib.hooks.SSHHook.Popen" title="Permalink to this definition">¶</a></dt>
<dd><p>Remote Popen</p>
<table class="docutils field-list" frame="void" rules="none">
<col class="field-name" />
<col class="field-body" />
...
<dl class="method">
<dt id="airflow.contrib.hooks.SSHHook.check_output">
<code class="descname">check_output</code><span class="sig-paren">(</span><em>cmd</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/ssh_hook.html#SSHHook.check_output"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.contrib.hooks.SSHHook.check_output" title="Permalink to this definition">¶</a></dt>
<dd><p>Executes a remote command and returns the stdout a remote process.
Simplified version of Popen when you only want the output as a string and detect any errors.</p>
<table class="docutils field-list" frame="void" rules="none">
<col class="field-name" />
<col class="field-body" />
<tbody valign="top">
<tr class="field-odd field"><th class="field-name">Parameters:</th><td class="field-body"><strong>cmd</strong> &#8211; command to remotely execute</td>
</tr>
<tr class="field-even field"><th class="field-name">Returns:</th><td class="field-body">stdout</td>
</tr>
</tbody>
</table>
</dd></dl>
...
<dl class="method">
<dt id="airflow.contrib.hooks.SSHHook.tunnel">
<code class="descname">tunnel</code><span class="sig-paren">(</span><em>*args</em>, <em>**kwds</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/ssh_hook.html#SSHHook.tunnel"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.contrib.hooks.SSHHook.tunnel" title="Permalink to this definition">¶</a></dt>
<dd><p>Creates a tunnel between two hosts. Like ssh -L &lt;LOCAL_PORT&gt;:host:&lt;REMOTE_PORT&gt;.
...
<dl class="class">
<dt id="airflow.contrib.hooks.CloudantHook">
<em class="property">class </em><code class="descclassname">airflow.contrib.hooks.</code><code class="descname">CloudantHook</code><span class="sig-paren">(</span><em>cloudant_conn_id='cloudant_default'</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/cloudant_hook.html#CloudantHook"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.contrib.hooks.CloudantHook" title="Permalink to this definition">¶</a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal"><span class="pre">airflow.hooks.base_hook.BaseHook</span></code></p>
...
<dl class="method">
<dt id="airflow.contrib.hooks.CloudantHook.db">
<code class="descname">db</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="reference internal" href="_modules/cloudant_hook.html#CloudantHook.db"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.contrib.hooks.CloudantHook.db" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="descclassname">airflow.executors.</code><code class="descname">CeleryExecutor</code><span class="sig-paren">(</span><em>parallelism=16</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/airflow/executors/celery_executor.html#CeleryExecutor"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#airflow.executors.CeleryExecutor" title="Permalink to this definition">¶</a></dt>
<dd><p>Bases: <code class="xref py py-class docutils literal"><span class="pre">airflow.executors.base_executor.BaseExecutor</span></code></p>
