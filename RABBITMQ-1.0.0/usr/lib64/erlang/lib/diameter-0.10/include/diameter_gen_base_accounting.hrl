...
-endif.
-ifndef('DIAMETER_BASE_ACCOUNTING_TERMINATION-CAUSE_DIAMETER_LOGOUT').
-define('DIAMETER_BASE_ACCOUNTING_TERMINATION-CAUSE_DIAMETER_LOGOUT', 1).
-endif.
-ifndef('DIAMETER_BASE_ACCOUNTING_TERMINATION-CAUSE_DIAMETER_SERVICE_NOT_PROVIDED').
-define('DIAMETER_BASE_ACCOUNTING_TERMINATION-CAUSE_DIAMETER_SERVICE_NOT_PROVIDED', 2).
-endif.
-ifndef('DIAMETER_BASE_ACCOUNTING_TERMINATION-CAUSE_DIAMETER_BAD_ANSWER').
-define('DIAMETER_BASE_ACCOUNTING_TERMINATION-CAUSE_DIAMETER_BAD_ANSWER', 3).
-endif.
-ifndef('DIAMETER_BASE_ACCOUNTING_TERMINATION-CAUSE_DIAMETER_ADMINISTRATIVE').
-define('DIAMETER_BASE_ACCOUNTING_TERMINATION-CAUSE_DIAMETER_ADMINISTRATIVE', 4).
-endif.
-ifndef('DIAMETER_BASE_ACCOUNTING_TERMINATION-CAUSE_DIAMETER_LINK_BROKEN').
-define('DIAMETER_BASE_ACCOUNTING_TERMINATION-CAUSE_DIAMETER_LINK_BROKEN', 5).
-endif.
-ifndef('DIAMETER_BASE_ACCOUNTING_TERMINATION-CAUSE_DIAMETER_AUTH_EXPIRED').
-define('DIAMETER_BASE_ACCOUNTING_TERMINATION-CAUSE_DIAMETER_AUTH_EXPIRED', 6).
-endif.
-ifndef('DIAMETER_BASE_ACCOUNTING_TERMINATION-CAUSE_DIAMETER_USER_MOVED').
-define('DIAMETER_BASE_ACCOUNTING_TERMINATION-CAUSE_DIAMETER_USER_MOVED', 7).
-endif.
-ifndef('DIAMETER_BASE_ACCOUNTING_TERMINATION-CAUSE_DIAMETER_SESSION_TIMEOUT').
-define('DIAMETER_BASE_ACCOUNTING_TERMINATION-CAUSE_DIAMETER_SESSION_TIMEOUT', 8).
-endif.
