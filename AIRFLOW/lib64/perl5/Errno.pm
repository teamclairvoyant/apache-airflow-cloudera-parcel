...
"x86_64-linux-thread-multi-3.10.0-514.16.1.el7.x86_64" or
	die "Errno architecture (x86_64-linux-thread-multi-3.10.0-514.16.1.el7.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
